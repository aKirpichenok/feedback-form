    ...
    <div>
      ...
      <form onSubmit={submit} noValidate>
        ...
        <input 
            type="text" 
            name="name" 
            placeholder="ANDREY KIRPICHONAK"
            value={name.value} 
        ...
        <input 
            ...
            name="mail" 
            placeholder="a.kirpichenok@gmail.com" 
            />
        ...
        <input 
            ...
            onBlur={(e: any) => phone.onBlur(e)} 
            name="phone" 
            placeholder="+7 923332123" 
            />
        ...
        <button 
          type="submit"
          className="red" 
          disabled={!name.inputValid || !mail.inputValid || !phone.inputValid || !date.inputValid || !message.inputValid || fetching}
          >
            Send
        </button>
      </form>
